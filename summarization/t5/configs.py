...
def add_args(parser):
    parser.add_argument("--task", type=str, required=False, default="summarize",
    ...
    parser.add_argument("--data_dir", type=str, required=False, default="../dataset/tl")
    parser.add_argument("--res_dir", type=str, required=False, default="results")
    parser.add_argument("--res_fn", type=str, default='results/summarize_codet5_base.txt')
