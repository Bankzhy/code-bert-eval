...
from summarization.custom_decoder import CustomJSONDecoder
...
def main():
    ...
    parser.add_argument("--model_name_or_path", default=r"H:\research\clone\examples\codebert-base", type=str, required=False,
                        help="Path to pre-trained model: e.g. roberta-base" )   
    parser.add_argument("--output_dir", default="model/java", type=str, required=False,
...
if __name__ == "__main__":
    main()
    # read_examples("dataset/tl/train")
    # read_examples("dataset/tl/train.jsonl")
